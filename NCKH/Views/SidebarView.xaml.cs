...
public partial class SidebarView : ContentView, INotifyPropertyChanged
{
    ...
    private async void OnQuanLyNCKHTapped(object sender, EventArgs e)
    {
        CloseSidebarIfMobile();
        // Chuyển hướng đến trang Quản lý phê duyệt
        await Shell.Current.GoToAsync("QuanLyPheDuyetPage");
    }
